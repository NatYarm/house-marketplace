...
import { storeImage, getListing, updateListing } from '../utils/firebase.utils';
...
const EditListing = () => {
  ...
  useEffect(() => {
    ...
    const fetchListing = async () => {
      ...
      reset({ ...selectedListing, address: selectedListing.location });
      setLoading(false);
    };

    fetchListing();
  }, [listingId, reset, setListing]);
  ...
  const onSubmit = async (data) => {
    ...
    updatedListing.location = data.address;
    delete updatedListing.images;
    delete updatedListing.address;
    ...
    navigate(`/category/${updatedListing.type}/${listingId}`);
  };
